...
<div class="container" style="margin-top: 90px;">
	<div class="wrapper">
		...
		<div class="col-lg-12" style="height:50vh;width:100%; background-image: url(<?php echo base_url().'assets/frontend/flixer/images/bg_image.png';?>)">
			<!--<h3 class="input_wrap"><?php echo get_phrase('Account');?></h3>-->
		</div>
		<div class="col-lg-12">
			<div class="row">
				<div class="col-lg-5">
			...
			<div class="row">
				<div class="col-lg-5">
					<span style="font-size: 20px;">
						<?php echo get_phrase('MEMBERSHIP_PLAN');?></span>
					<br>
				</div>
				<div class="col-lg-7">
					<div class="row" style="margin: 5px;">
