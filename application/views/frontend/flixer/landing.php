<!-- TOP LANDING SECTION -->
<div style="height:93vh;width:100%;background-image: url(<?php echo base_url().'assets/frontend/flixer/images/home_banner_3.jpg';?>)">
	<!-- logo -->
	<div style="float: left;">
		<a href="<?php echo base_url();?>index.php?home">
		<img src="<?php echo base_url();?>/assets/global/eMax Logo Banner-01.png" style="margin: 18px 18px; width: 160px;" />
		</a>
	</div>
	...
	<div style="font-size: 80px;font-weight: bold;clear: both;padding: 100px 0px 0px 0px; text-align:center; color: #fff;" class="hidden-xs">
		...
		<div style="font-size: 20px; letter-spacing: .2px; color: #fff; font-weight: 400;">
			<?php echo get_phrase('ARE_YOU_READY_TO_JOIN');?>
		</div>
		<a href="<?php echo base_url();?>index.php?home/signup" class="btn btn-danger btn-lg"
			style="padding: 20px 50px; font-size: 23px;">
					...
					<div class="tab-pane" id="anywhere">
						...
						<div class="row" style="margin-top:50px;text-align: center;">
							...
							<div class="col-md-3">
								...
								<h5><?php echo "Watch on your tablet";?></h5>
							</div>
							<div class="col-md-3">
								<img src="<?php echo base_url();?>assets/frontend/flixer/images/asset_mobile_phone_UI.png" style="width: 100%;" />
								<h5><?php echo "Watch on your mobile phone";?></h5>
							</div>
							<div class="col-md-3">
								<img src="<?php echo base_url();?>assets/frontend/flixer/images/asset_cancelanytime_withdevice.png" style="height: 32vh;width: 100%;" />
							...
							<tbody>
								...
								<tr>
									...
									<?php
										...
										foreach ($plans as $row):
										?>
									<td align="center">GH₵ <?php echo $row['price'];?></td>
									<?php endforeach;?>
								</tr>
								<tr>
