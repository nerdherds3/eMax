...
<head>
    <?php //echo $page_title;?>
    <title>eMax | <?php echo $this->db->get_where('settings',array('type'=>'site_name'))->row()->description;?></title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/flixer/css/signin.css'?>">
    <link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/flixer/css/signup.css'?>">
    ...
    .blue_text{color: #00ff00;}
    </style>
</head>
<?php
$bg_display = "background-color:#000";
...
$bg_display = "height:93vh;width:100%; background-image: url(http://localhost/eMax/assets/frontend/flixer/images/subscription_banner.png)";
?>
<body style="<?php echo $bg_display;?>">
